...
- [x] **Task 1: Manually Scaffold Vite + TypeScript Project**
  ...
  * Create an empty or basic `src/main.ts`.
  * Run `npm install` (or `npm i --no-fund --no-audit`) to install the dependencies silently.
  * **Tests:** Strictly run **`npm exec tsc --noEmit`** and assert zero errors. Verify that `index.html` and `src/main.ts` exist.
 ...
 * [ ] Task 4: Define Core TypeScript Types and Interfaces
 ...
 * [ ] Task 6: Implement Date Utility Functions
 ...
 * [ ] Task 7: Implement LocalStorage Persistence Utilities
 ...
 * [ ] Task 8: Define the Default Application State
 ...
 * [ ] Task 9: Implement the State Store with Subscriber Pattern
 ...
 * [ ] Task 10: Implement All Todo Mutation Actions
 ...
 * [ ] Task 11: Implement the Derived Selector for Filtered Todos
 ...
 * [ ] Task 12: Bootstrap the Root HTML Shell
 ...
 * [ ] Task 13: Implement the createElement DOM Utility
 ...
 * [ ] Task 14: Implement the Header Component
 ...
 * [ ] Task 15: Implement the Stats Bar Component
 ...
 * [ ] Task 16: Implement the Filter Bar Component
 ...
 * [ ] Task 17: Implement the Add-Todo Form Component
 ...
 * [ ] Task 18: Implement the Todo Card Component
 ...
 * [ ] Task 19: Implement the Edit-Todo Modal Component
 ...
 * [ ] Task 20: Implement the Empty State Component
...
## Phase 5: Application Shell & Rendering Engine
 * [ ] Task 21: Implement the Todo List Renderer
 ...
 * [ ] Task 22: Implement the Main App Render Function
 ...
 * [ ] Task 23: Bootstrap and Subscribe the Renderer in main.ts
 ...
 * [ ] Task 24: Add ARIA Attributes to All Interactive Components
 ...
 * [ ] Task 25: Implement Keyboard Trap for the Edit Modal
 ...
 * [ ] Task 26: Configure Vite Production Build Options
